...
namespace Sage.AccountingKeyPayIntegrationPOC.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        private readonly AccountingKeyPayIntegrationPOCDbContext _context;

        public HostRoleAndUserCreator(AccountingKeyPayIntegrationPOCDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new AccountingKeyPayIntegrationPOCAuthorizationProvider())
